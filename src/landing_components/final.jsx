...
export default function Final(){
    return(
      <section className="py-16 px-4 text-center md:pt-40 md:pb-40 pt-10 pb-10 bg-blue-100">
  <div className="max-w-3xl mx-auto">
    ...
    <Link to="/contact" className="inline-block bg-blue-500 text-white px-5 py-2 rounded-full text-s font-semibold hover:bg-blue-700 transition kollektif-font">Join Now</Link>
