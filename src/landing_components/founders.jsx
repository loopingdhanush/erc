    ...
    <section className="py-16 px-4 ">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
          ...
          <div className="bg-white rounded-2xl border border-blue-200 shadow-lg shadow-blue-200 overflow-hidden ">
            <img
              src={member1}
...
<div className="max-w-4xl mx-auto bg-white shadow-lg border border-blue-200 shadow-blue-200 rounded-2xl overflow-hidden mt-16">
